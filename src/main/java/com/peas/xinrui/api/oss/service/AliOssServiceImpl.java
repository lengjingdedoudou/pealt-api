...
import com.peas.xinrui.api.oss.entity.OssEntity;
...
public class AliOssServiceImpl implements AliOssService, InitializingBean {
    ...
    public String upload(MultipartFile file) {
        ...
        try {
            ...
            // 生成文件夹 xx/xx/a98059d4633c4b55b31093c997cf8038.png
    ...
    public List<String> listFile() {
        ...
        ObjectListing objectListing = ossClient.listObjects("xinrui-user-avatar/student");
